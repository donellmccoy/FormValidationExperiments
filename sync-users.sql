...
UPDATE AspNetUsers SET UserName = '_old_' + Id, NormalizedUserName = '_OLD_' + UPPER(Id), Email = '_old_' + Id, NormalizedEmail = '_OLD_' + UPPER(Id);
...
DELETE FROM AspNetUsers WHERE Id NOT IN ('a8043ac0-c64c-4318-b621-5ca404db7085','aa6be79c-ee31-45e1-9aed-48c8a68e9264','c6659170-2072-45b8-a1d1-3b596fd2befa');
COMMIT;
SELECT 'AspNetUsers' AS T, COUNT(*) AS N FROM AspNetUsers UNION ALL SELECT 'AspNetRoles', COUNT(*) FROM AspNetRoles UNION ALL SELECT 'AspNetUserRoles', COUNT(*) FROM AspNetUserRoles;
