...
public class WorkflowStateLookupConfiguration : IEntityTypeConfiguration<WorkflowStateLookup>
{
    public void Configure(EntityTypeBuilder<WorkflowStateLookup> builder)
    {
        ...
        builder.HasData(
            ...
            new WorkflowStateLookup { Id = (int)WorkflowState.BoardTechnicianReview,     Name = "Board Technician Review",     Description = "Board medical technician reviews the case file for completeness and accuracy.",                       DisplayOrder = 8,  WorkflowTypeId = 1 },
            new WorkflowStateLookup { Id = (int)WorkflowState.BoardMedicalReview,        Name = "Board Medical Review",        Description = "Board medical officer reviews all medical evidence and provides a formal assessment.",                 DisplayOrder = 9,  WorkflowTypeId = 1 },
            ...
            new WorkflowStateLookup { Id = (int)WorkflowState.BoardAdminReview,          Name = "Board Admin Review",          Description = "Board administrative officer finalizes the case package and prepares the formal determination.",      DisplayOrder = 11, WorkflowTypeId = 1 },
