...
public partial class CreateCase : ComponentBase
{
    ...
    private async Task OnSubmit(MemberInfoFormModel model)
    {
        ...
        try
        {
            var newCase = new FormValidationExperiments.Shared.Models.LineOfDutyCase
            {
                IncidentType = incidentType,
                ProcessType = processType
            };
            FormValidationExperiments.Shared.Mapping.LineOfDutyCaseMapper.ApplyMemberInfo(memberFormModel, newCase);
